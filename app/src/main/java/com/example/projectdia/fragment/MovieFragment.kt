...
import com.example.projectdia.MovieDetailActivity
...
import com.example.projectdia.ultils.MovieRepository
...
class MovieFragment : Fragment(), MovieClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val service = MovieRepository.create()
        service.getPopularMovie(page = 1).enqueue(object: Callback<MovieResponseModel>{
